...
<p align="center">用户名：<input type="text" id="yhm" onblur="upperCase1()"></p>
<p id=text1>用户名长度小于15字节</p>
<p align="center">输入密码：<input type="password" id="pwd1" onblur="upperCase2()"> </p>
<p id=text2>密码长度小于15字节，包含英文，数字，符号其中两个</p>
<p align="center">重复密码：<input type="password" id="pwd2" onblur="upperCase3()"> </p>
...
<div id=zhuceanniu>
<input name=zhuce type="submit" value="点击注册">
</div>
</form>
</div>
</div>
